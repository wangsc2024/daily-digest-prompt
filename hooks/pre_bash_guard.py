...
FALLBACK_BASH_RULES = [
    ...
    },
    {
        ...
        "patterns": [
            r"curl\s.{0,200}(-d|--data|--data-binary|--data-raw|--data-urlencode)\s+@\s*\.env\b",
            r"curl\s.{0,200}(-d|--data|--data-binary|--data-raw|--data-urlencode)\s+@\s*credentials",
            r"curl\s.{0,200}(-d|--data|--data-binary|--data-raw|--data-urlencode)\s+@\s*token\.json",
            r"curl\s.{0,200}(-d|--data|--data-binary|--data-raw|--data-urlencode)\s+@\s*secrets\.json",
            r"curl\s.{0,200}(-d|--data|--data-binary|--data-raw|--data-urlencode)\s+@\s*\.htpasswd",
            r"curl\s.{0,200}(-d|--data|--data-binary|--data-raw|--data-urlencode)\s+@\s*id_rsa",
            r"curl\s.{0,200}(-d|--data|--data-binary|--data-raw|--data-urlencode)\s+@\s*id_ed25519",
        ],
        "flags": "IGNORECASE",
    ...
    },
    {
        ...
        "patterns": [
            r"cat\s+.{0,200}\.(env|htpasswd)\s*\|.{0,200}curl",
            r"cat\s+.{0,200}(credentials|secrets|token)\.json\s*\|.{0,200}curl",
            r"cat\s+.{0,200}(id_rsa|id_ed25519)\s*\|.{0,200}curl",
            r"cat\s+.{0,200}\.(env|htpasswd)\s*\|.{0,200}(wget|nc\s)",
            r"cat\s+.{0,200}(credentials|secrets|token)\.json\s*\|.{0,200}(wget|nc\s)",
        ],
        "flags": "IGNORECASE",
    ...
    },
    {
        ...
        "patterns": [
            r"(curl|wget)\s.{0,200}(\$\(|`)cat\s+.{0,200}\.(env|htpasswd)",
            r"(curl|wget)\s.{0,200}(\$\(|`)cat\s+.{0,200}(credentials|secrets|token)\.json",
            r"(curl|wget)\s.{0,200}(\$\(|`)cat\s+.{0,200}(id_rsa|id_ed25519)",
        ],
        "flags": "IGNORECASE",
    ...
    },
    {
        ...
        "patterns": [
            r"base64\s+\.env\b.{0,200}\|\s*(curl|wget)",
            r"base64\s+(credentials|secrets|token)\.json.{0,200}\|\s*(curl|wget)",
            r"base64\s+(id_rsa|id_ed25519).{0,200}\|\s*(curl|wget)",
            r"base64\s+\.htpasswd.{0,200}\|\s*(curl|wget)",
            r"cat\s+.{0,200}\.(env|htpasswd)\s*\|.{0,200}base64.{0,200}\|\s*(curl|wget)",
            r"cat\s+.{0,200}(credentials|secrets|token)\.json\s*\|.{0,200}base64.{0,200}\|\s*(curl|wget)",
            r"cat\s+.{0,200}(id_rsa|id_ed25519)\s*\|.{0,200}base64.{0,200}\|\s*(curl|wget)",
        ],
        "flags": "IGNORECASE",
