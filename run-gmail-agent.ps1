...
$PromptFile = "$AgentDir\daily-gmail-prompt.md"
...
$LogFile = "$LogDir\gmail_$Timestamp.log"
...
# Start execution
$startTime = Get-Date
Write-Log "=== Gmail Agent start: $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss') ==="
...
Get-ChildItem -Path $LogDir -Filter "gmail_*.log" |
