...
### Phase 1：SCOPE（界定範疇）
```
【方向鎖定】研究目標以「深入學習」為導向，非「學術討論」。
子問題應聚焦於「能理解什麼、能應用什麼、能從中學到什麼」，
而非辯論爭議、梳理學派分歧或追求窮盡文獻。
```
- 分解研究問題為 3-5 個子問題，每個子問題須能回答「學習者能從中獲得什麼」
- 確認成功標準：讀者讀完後能**理解核心機制、掌握關鍵概念、知道如何應用**
- 識別潛在偏見與假設
- **排除項**：不以「爭議誰對誰錯」「窮舉所有學術觀點」「中立呈現各方立場」為目標；若主題確有重要爭議，以「學習者需知道什麼」為篩選依據，點到即止
...
- 量化數據（"效能提升 23%"，非"顯著提升"）
- 禁止：添加無法從來源驗證的推斷
- **學習導向撰寫**：報告語氣以「教學者向學習者說明」為基調；「實務應用建議」章節為必寫項，說明讀者學完後能做什麼；爭議性觀點若與學習無直接關聯，可縮減篇幅或移至附注
