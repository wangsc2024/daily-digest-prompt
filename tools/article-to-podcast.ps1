...
# Podcast 生成工具：知識庫文章 → 雙主持人（＋可選來賓聲線）對話 MP3
# ============================================================
# 用法：
...
# ============================================================
# Phase 2：TTS 生成（host_a / host_b / host_guest）
# ============================================================
...
if (Test-Path $cfgPath) {
    # 簡單 grep 取得 voice_a / voice_b / voice_guest（避免需要 Python 解析 YAML）
